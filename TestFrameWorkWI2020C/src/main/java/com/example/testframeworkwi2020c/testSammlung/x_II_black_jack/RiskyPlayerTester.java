...
public class RiskyPlayerTester {
    ...
    public TestResult<Integer[]> testGetOffer() throws Exception {
        ...
        // Berechne einen temporären Wert als totalBudget / 4 und ziehe ihn von totalBudget ab
        ...
        if (result == temp) {
            ...
            return new TestResult<>(false, new Integer[]{temp, result}); // Test fehlgeschlagen, gib den temporären Wert und das Ergebnis zurück
        }
    }
    ...
    public TestResult<String> testGetChoice() throws Exception {
        ...
        // Rufe die Methode getChoice der Klasse mit einem Argument von 19 auf
