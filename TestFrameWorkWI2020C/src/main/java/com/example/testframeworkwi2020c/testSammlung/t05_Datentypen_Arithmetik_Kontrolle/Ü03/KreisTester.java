...
public class KreisTester {
    ...
    public int setR()  {
        ...
        if(variableValue == null || (int)variableValue == 0){
           CodeRunnerBackend.invokeMethodByName(objectList, className, "setR",  new Object[]{3}, new Class[]{int.class});;
           return 3;
        }else{
    ...
    public TestResult<String> testGetArea() throws Exception {
        ...
        double areaValue = Math.PI*variableValue*variableValue;
    ...
    public TestResult<String> testGetCircumference() throws Exception {
        ...
        outputStreamCaptor= new ByteArrayOutputStream();
        int variableValue = setR();
        double circumferenceValue = 2*Math.PI*variableValue;
        System.setOut(new PrintStream(outputStreamCaptor));
